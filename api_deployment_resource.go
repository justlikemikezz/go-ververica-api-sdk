 ...
 * @param deploymentChange deploymentChange
 * @param namespace namespace

@return Deployment
*/
func (a *DeploymentResourceApiService) CreateDeploymentUsingPOST(ctx context.Context, deploymentChange Deployment, namespace string) (Deployment, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &deploymentChange
...
func (a *DeploymentResourceApiService) GetDeploymentsUsingGET(ctx context.Context, namespace string, localVarOptionals *GetDeploymentsUsingGETOpts) (ResourceListDeployment, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
