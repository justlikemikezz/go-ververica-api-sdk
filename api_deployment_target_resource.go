...
*/
func (a *DeploymentTargetResourceApiService) GetDeploymentTargetsUsingGET(ctx context.Context, namespace string) (ResourceListDeploymentTarget, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
