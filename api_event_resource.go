...
func (a *EventResourceApiService) GetEventsUsingGET(ctx context.Context, namespace string, localVarOptionals *GetEventsUsingGETOpts) (ResourceListEvent, *http.Response, error) {
	var (
