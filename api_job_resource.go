...
func (a *JobResourceApiService) GetJobsUsingGET(ctx context.Context, namespace string, localVarOptionals *GetJobsUsingGETOpts) (ResourceListJob, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
