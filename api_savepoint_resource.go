...
func (a *SavepointResourceApiService) GetSavepointsUsingGET(ctx context.Context, namespace string, localVarOptionals *GetSavepointsUsingGETOpts) ([]Savepoint, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
